...
@WebServlet("/viewAllChangedDates")
public class ViewAllChangedDateTimesController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/jsp/ViewAllSingularDateTimes.jsp");
        dispatcher.forward(request, response);
        return;
    }
